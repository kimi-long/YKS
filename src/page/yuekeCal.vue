                                                    ...
                                                    <div class="am-tabs-tab-bar-wrap">
                                                        <div
                                                            ...
                                                            <div role="tablist" class="am-tabs-default-bar-content">
                                                                <div
                                                                    class="am-tabs-default-bar-tab"
                                                                    :class="activeIndex == 0?'am-tabs-default-bar-tab-active':''"
                                                                    @click="getListTeacherRowClass(0)">
                                                                    <span
                                                                ...
                                                                <div class="am-tabs-default-bar-tab"
                                                                     ...
                                                                     @click="getListTeacherRowClass(1)">
                                                                    <span
                                                                ...
                                                                <div class="am-tabs-default-bar-tab"
                                                                     ...
                                                                     @click="getListTeacherRowClass(2)">
                                                                    <span
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <div v-for="(item,index) in classList">
                                                                        ...
                                                                        <div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        class="CdnImage__ImageWithBackground-sc-1pzwnhb-0 image"
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="lesson-information">
                                                                                            ...
                                                                                            <div
                                                                                                class="lesson-price"><span
                                                                                                class="color-font period-count">{{item.ConsumptionOfClass}}课时</span><span
                                                                                                class="color-font price"
                                                                                                v-if="item.preAboutType == '3' || item.preAboutType == '1'">￥{{item.singlePrice}}</span>
                                                                                            </div>
                                                                                            <div class="teacher"><span>{{item.Name}}</span>
                                                                                            </div>
                                                                                        </div>
                                                                                        <span
                                                                                            class="NewLessonItem__StatusBadgeWrapper-sc-1f60nxc-4 bcgiLI right-side"
                                                                                            v-if="item.showstate == 1">已结束</span>
                                                                                        <a role="button"
                                                                                           v-if="item.showstate == 0"
                                                                ...
                                                                <div v-if="item.showstate == '0'">
                                                                    <div
                                                                        @click="tolesson(item.ID,item.PreAboutID,item.ID)"
                                                                        class="NewLessonItem__Wrapper-sc-1f60nxc-0 dddPAx new-lesson-item">
                                                                        <div>
                                                                            <div
                                                                                class="NewLessonItem__MainContent-sc-1f60nxc-1 hzSaX">
...
<script>
    ...
    import {getListRowClass, getListTeacherRowClass} from '../api/getData'
    ...
    export default {
        ...
        mounted() {
            jQuery('.am-tabs-default-bar-tab').click(function () {
                TabSelect(".am-tabs-default-bar-tab", "div.lists", "am-tabs-default-bar-tab-active", jQuery(this))
            });
...
//tab function
        ...
        methods: {
            ...
            tolesson(id, PreAboutID, RowClassID) {
                this.$router.push({
                    path: '/lesson',
                    query: {id: id, type: 5, PreAboutID: PreAboutID, RowClassID: RowClassID}
                })
            },
            dateP(data) {
                ...
                this.getListTeacherRowClass(this.activeIndex);
            },
            async getListTeacherRowClass(data) {
                this.loading = true;
                this.activeIndex = data;
                const crs = await getListTeacherRowClass({

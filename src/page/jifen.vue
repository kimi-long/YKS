                                                        ...
                                                        >
                                                            <div role="tablist" class="am-tabs-default-bar-content">
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="ShopCalendar__TabTitle-sc-1ovuswm-2 kSYPKF">赠送记录</span>
                                                                    <i></i>
                                                                </div>
                                                                <div class="am-tabs-default-bar-tab" :class="activeIndex == 2?'am-tabs-default-bar-tab-active':''" @click="changeTab(2)">
                                                                    <span
                                                                        class="ShopCalendar__TabTitle-sc-1ovuswm-2 kSYPKF">兑换记录</span>
                                                                    <i></i>
                                                                </div>
                                                            </div>
                                                        </div>
...
<!--                                                                </section>-->
                                                                <div class="CardTemplateComponent__CardTemplateTextWrapper-sc-1slov8k-2 jzSyzs">
                                                                    ...
                                                                    <p  v-if="activeIndex == 1"><span class="jifenT">赠送日期：</span><span class="jifenText">{{item.addTime}}</span></p>
                                                                    <p  v-if="activeIndex == 2"><span class="jifenT">兑换日期：</span><span class="jifenText">{{item.addTime}}</span></p>
                                                                    <p><span class="jifenT">操作人：</span><span class="jifenText">{{item.HypeName}}</span></p>
                                                                    <p v-if="activeIndex == 1"><span class="jifenT">赠送积分：</span><span class="jifenText">{{item.integral}}</span></p>
                                                                    <p v-if="activeIndex == 2"><span class="jifenT">兑换积分：</span><span class="jifenText">{{item.integral}}</span></p>
                                                                    <p><span class="jifenT">操作时间：</span><span class="jifenText">{{item.UpdTime}}</span></p>
                                                                    <p><span class="jifenT">备注：</span><span class="jifenText">{{item.Note}}</span></p>
...
<script>
    import {getListJFAdminHype} from '../api/getData'
    ...
    export default {
        ...
        methods: {
            changeTab(num){
                this.orderList = [];
                this.pageIndex = 0;
                this.getListJFAdminHype(num,1)
            },
            onLoad() {
                if (!this.isAdding) {
                    this.getListJFAdminHype(this.activeIndex,2);
                }
                this.tableLoading = false;
            },
            async getListJFAdminHype(data,num) {
                if(num == 1){
                    this.pageIndex = 0;
                    this.orderList = [];
                }
                ...
                const crs = await getListJFAdminHype({
